...
//------------------------------------------------------------------------------------------
	class DoorX extends FarXObstacle {
...
//------------------------------------------------------------------------------------------
		public override function setupX ():Void {
			...
			setNamedCX ("mouseOver", -48, 48, -96, 0);
...
//------------------------------------------------------------------------------------------
		public override function createSprites ():Void {
			...
			sprite = createXMovieClip("Assets:DoorClass");
			...
			addTask ([
				XTask.LABEL, "loop",
					...
					XTask.FLAGS, function (__XTask:XTask):Void {
						__XTask.ifTrue (m_inrange /* && xxx.getKeyCode (38) */);
					},
